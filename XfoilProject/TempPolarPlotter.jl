...
#TO UNDO UNCOMMENT/COMMENT ANYTHING BY CAPPED HEADINGS 
    ...
    #Plots
    ClPlot = plot(alpha, Cl, title = "Cl", xlabel = "Angle of Attack\n", ylabel = "\nCoefficient")
    CdPlot = plot(alpha, Cd, title = "Cd", xlabel = "Angle of Attack\n", ylabel = "\nCoefficient")
    CdpPlot = plot(alpha, Cdp, title = "Cdp", xlabel = "Angle of Attack\n", ylabel = "\nCoefficient")
    CmPlot = plot(alpha, Cm, title = "Cm", xlabel = "Angle of Attack\n", ylabel = "\nCoefficient")
    PlotArray = []
push!(PlotArray,ClPlot)
push!(PlotArray,CdPlot)
push!(PlotArray,CdpPlot)
push!(PlotArray,CmPlot)
plot(PlotArray...)
